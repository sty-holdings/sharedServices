...
const (
	...
	PSQL_CONN_FALIED                           = "No database connection has been established."
	PSQL_CONN_EMPTY                            = "Database connection is empty."
	PSQL_DB_NAME_EMPTY                         = "Database name is empty."
	PSQL_DB_NAME_INVALID                       = "Database name is invalid."
	PSQL_HOST_EMPTY                            = "PSQL Host is empty."
	...
	PSQL_TIMEOUT_INVALID                       = "PSQL timeout is invalid. Must be greater than 0 and less than 5 seconds."
	PSQL_USER_EMPTY                            = "You must provide an encrypted PSQL user name."
	...
	SERVICE_FAILED_PSQL                        = "POSTGRES service has failed. Investigate right away!"
	...
	STYH_USER_ID_INVALID                       = "The STYH User Id is invalid."
	STYH_USER_ID_MISSING                       = "The UID is missing."
	...
	UID_MISSING                                = "The STYH User Id is missing."
...
var (
	...
	ErrPSQLConnFalied                        = errors.New(PSQL_CONN_FALIED)
	ErrPSQLConnEmpty                         = errors.New(PSQL_CONN_EMPTY)
	ErrPSQLDBNameEmpty                       = errors.New(PSQL_DB_NAME_EMPTY)
	ErrPSQLDBNamenvalid                      = errors.New(PSQL_DB_NAME_INVALID)
	ErrPSQLHostEmpty                         = errors.New(PSQL_HOST_EMPTY)
	...
	ErrPSQLTimeoutInvalid                    = errors.New(PSQL_TIMEOUT_INVALID)
	ErrPSQLUserEmpty                         = errors.New(PSQL_USER_EMPTY)
	...
	ErrServiceFailedPSQL                     = errors.New(SERVICE_FAILED_PSQL)
